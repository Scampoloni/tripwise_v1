...
import { n as getTripById, p as getExpensesForTrip } from "../../../../chunks/db.js";
...
function normalizeParticipants(list) {
  ...
  return sanitized.length > 0 ? sanitized : FALLBACK_PARTICIPANTS.map((participant) => ({ ...participant }));
}
